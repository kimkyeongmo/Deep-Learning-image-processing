...
train_ds = image_dataset_from_directory(data_path, vallidation_split=0.2, subset='training',seed=123,image_size=(224,224),batch_size=16)
test_ds=image_dataset_from_directory(data_path, vallidation_split=0.2, subset='validation',seed=123, image_size=(224,224), batch_size=16)
...
print(cnn.evaluate(test_ds, verbose=0)[1]*100)
